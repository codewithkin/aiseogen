  ...
  return (
    <section className="w-full px-2 py-2 md:px-8 md:py-4 flex justify-between items-center border-b border-gray-200">
        ...
        <article className="flex items-center justify-center gap-2">
            <Link className="px-4 py-2 hidden md:block transition duration-300 hover:bg-blue-500 hover:text-white rounded-xl border-2 border-blue-500 text-blue-500" href="mailto:support@aiseogen.com">
                Report a bug
            </Link>
